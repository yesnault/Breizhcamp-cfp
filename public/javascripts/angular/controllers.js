...
function DashboardController($rootScope, $scope, ProfilService, AccountService, UserService, StatService, $log) {
    ...
    $scope.proposalsDraft = ProfilService.getProposals(idUser);
...
ListProposalsController.$inject = ['$scope', '$log','$http', 'AllProposalService', 'VoteService','ProposalService', 'UserService'];
function ListProposalsController($scope, $log,http, AllProposalService, VoteService,ProposalService,UserService) {
